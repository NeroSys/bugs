...
<main id="main-container">
    ...
    <div class="content content-boxed">
        ...
        <div class="block">
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <?= Html::a('<span class="glyphicon glyphicon-eye-open"></span>',
                                        ['courses/view', 'id' => $item->id],
                                        ['data-method' => 'post']) ?>
                                    <?= Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                                        ['courses/update', 'id' => $item->id],
                                        ['data-method' => 'post']) ?>
                                    <?= Html::a('<span class="glyphicon glyphicon-trash"></span>',
                                        ['courses/delete', 'id' => $item->id],
                                        ['data-method' => 'post']) ?>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="block">
                <div class="block-header">
                    <h3 class="block-title">Совпадений с <?= $q ?> в переводах - <small><?php if (!empty($subItems)){ echo count($subItems);}else{ echo 0;} ?> позиций</small></h3>
                </div>
                <div class="block-content">
                    <?php if (!empty($subItems)): ?>
                        ...
                        <table class="table table-bordered table-striped js-dataTable-simple">
                            ...
                            <?php foreach ($subItems as $subItem): ?>
                                <tr>
                                    <td class="text-center"><?= $subItem->art_id ?></td>
                                    <td class="font-w600"><?= $subItem->name ?></td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <?= Html::a('<span class="glyphicon glyphicon-eye-open"></span>',
                                                ['courses/view', 'id' => $subItem->art_id],
                                                ['data-method' => 'post']) ?>
                                            <?= Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                                                ['courses/update', 'id' => $subItem->art_id],
                                                ['data-method' => 'post']) ?>
                                            <?= Html::a('<span class="glyphicon glyphicon-trash"></span>',
                                                ['courses/delete', 'id' => $subItem->art_id],
                                                ['data-method' => 'post']) ?>
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <?php else: ?>
                        <p>Совпадений в контенте переводов не найдено.</p>
                    <?php endif; ?>
                </div>
            </div>
            <!-- END Dynamic Table Simple -->
