...
$newMessages = Messages::find()->where(['isNew' => 1])->all();
        ...
        <li>
            <div class="btn-group">
                <button class="btn btn-default btn-image dropdown-toggle" data-toggle="dropdown" type="button">
                    <img src="/backend/web/img/avatars/admin.jpg" alt="Avatar">
                    <span class="caret"></span>
                </button>
                <ul class="dropdown-menu dropdown-menu-right">
                    <li class="dropdown-header"><?= \Yii::$app->user->identity->username; ?></li>
                    <li>
                        <a tabindex="-1" href="<?= Url::to(['/messages/index']) ?>">
                            <i class="si si-envelope-open pull-right"></i>
                            <span class="badge badge-primary pull-right"><?= count($newMessages)?></span>Входящие
                        </a>
                    </li>
                    <li class="divider"></li>
                    <li>
